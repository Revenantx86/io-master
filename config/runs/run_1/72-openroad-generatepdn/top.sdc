...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {vccd1}]
...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {vssd1}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {vccd1}]
...
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {vssd1}]
###############################################################################
# Environment
###############################################################################
